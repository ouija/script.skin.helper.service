...
'''
    ...
    Contextmenu for tv show search with genesisreborn plugin
'''
...
if __name__ == '__main__':
    ...
    if dbId:
        ...
        if json_result:
            ...
            exec_plugin = kodi_json("Addons.ExecuteAddon", { "addonid": "plugin.video.genesisreborn", "params" : { "action": "tvshowPage", "url": "http%3A%2F%2Fapi.trakt.tv%2Fsearch%2Fshow%3Flimit%3D20%26page%3D1%26query%3D"+showtitle} })
